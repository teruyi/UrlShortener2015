...
@Configuration
@EnableScheduling
public class WarningQueueConfiguration {
    ...
    public WarningListener listenerWarning(){
        return new WarningListener();
    }

    @Bean
    // Periodic check for available URIs (in one thread).
    public WarningPeriodicCheck periodicCheckWarning() {
        return new WarningPeriodicCheck();
    }
