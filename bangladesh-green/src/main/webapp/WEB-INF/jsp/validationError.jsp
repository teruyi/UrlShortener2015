...
<div class=" mainBackground" style="padding:20px;">
    <img src="images/error.png" class="lockImage">
    <p class="lockText">403: Not authorized</p>
    <p class="lockTextSecondary">You are trying to validate an user without a valid token.</p>
    <br/>
    <p class="lockTextSecondary">Please provide the supplied token as sent in the email.</p>
